...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Control Panel | View Employees</title>
        <!-- Awesome Fonts -->
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                                <div class="">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" name="employeesName" value="<?php echo $row['name'] ?>" readonly>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="roleName" value="<?php echo $row['role'] ?>" readonly>
                                    </div>
                                </div>
                            </form>
                    </div>
